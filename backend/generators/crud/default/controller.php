...
<?php endif; ?>
     ...
     * @return mixed
     */
    public function actionCreate(<?php echo $actionParams ?> = null)
    {
        $model = new <?php echo $modelClass ?>();

        if (<?php echo $actionParams ?>) {
            $model = $this->findModel(<?php echo $actionParams ?>);
        }
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render(<?php echo $actionParams ?> ? 'update' : 'create', [
                'model' => $model,
            ]);
        }
    }
    ...
    {
        return $this->actionCreate(<?php echo $actionParams ?>);
    }
