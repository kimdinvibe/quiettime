...
class WebviewController extends Controller
{
    ...
    /**
     * Lists all Webview models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new WebviewSearch();
    ...
    /**
     * Updates an existing Webview model.
    ...
    /**
     * Deletes an existing Webview model.
    ...
    {
        if (($model = Webview::findOne($id)) !== null) {
            return $model;
        } else {
