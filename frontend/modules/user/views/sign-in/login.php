            ...
            <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
                ...
                <div style="color:#999;margin:1em 0">
                    <?php echo Yii::t('frontend', 'If you forgot your password you can reset it <a href="{link}">here</a>', [
                        'link'=>yii\helpers\Url::to([$modal?'/user/sign-in/request-password-reset':'sign-in/request-password-reset'])
                    ]) ?>
                </div>
...
<!--                <div class="form-group">-->
<!--                    --><?php //echo Html::a(Yii::t('frontend', 'Need an account? Sign up.'), [$modal?'/user/sign-in/signup':'signup']) ?>
<!--                </div>-->
