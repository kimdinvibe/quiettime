...
class I18nMessageController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($params = Yii::$app->request->getQueryParams()) {
            if (isset($params['id'])) {
                $model->id = $params['id'];
            }
        }
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['i18n-source-message/view', 'id' => $model->id]);
        } else {
    ...
    public function actionUpdate($id, $language)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(Url::previous('i18n-messages-filter') ?: ['i18n-source-message/view', 'id' => $model->id]);
        } else {
