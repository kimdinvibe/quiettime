...
//            'dateFormat' => 'php:l j'
        ...
        'mailer' => [
            ...
            'transport' => getenv('MAILER_TRANSPORT') == 'smtp' ? [
                ...
                'port' => getenv('MAILER_PORT'), // Port 25 is a very common port too
                'encryption' => getenv('MAILER_ENCRYPTION'), // It is often used, check your provider or mail server specs
            ] : []
        ],
