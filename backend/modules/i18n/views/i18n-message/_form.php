...
<div class="i18n-message-form">
    ...
    <div style="<?php echo (Yii::$app->request->getQueryParam('id') ? "display: none" : "") ?>">
    ...
    <?php /* $languages = ArrayHelper::map(
        \common\models\Dictionary::find()->select('code')->locale()->andWhere(
            ['not like', 'code', '_']
        )->distinct()->all(),
        'code',
        'code'
