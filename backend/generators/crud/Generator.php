...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'CRUD Generator for iOS and Android';
    }
    ...
    public function generateSearchConditions()
    {
            ...
            switch ($type) {
                ...
                case Schema::TYPE_TIMESTAMP:
                    if (!in_array($column, ['created_at', 'updated_at'])) {
                        ...
                        $likeConditions[] = "->andFilterWhere(['<', '{$column}', strtotime(\$this->{$column})])";
                    }
                    break;
                default:
        ...
        // if (in_array($column, ['created_at', 'updated_at'])) {
        //     $conditions[] = "->andFilterWhere(['<', '{$column}', strtotime(\$this->{$column}]))";
        // } else {
